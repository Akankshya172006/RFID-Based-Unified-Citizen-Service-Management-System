...
const char card_ids[NUM_USERS][9] = {
    "12536316",     // Card ID - User 1 
    "12538224",     // Card ID - User 2 
    "01157435"      // Card ID - User 3 
};
...
const char addresses[NUM_USERS][6] = { "BBSR", "HYD", "BLR" };
...
u8 scan_officer_card(void)
{
    ...
    while (1)
    {
        ...
        if (rfid_ready)
        {
            ...
            // Check if card is the Officer Card ("12557813")
            if (is_same_id(card, "12557813", 8))
            {
                return 1;
            }
